(function() {
    ...
    /**
     * Сборщик абстрактного синтаксического дерева.
     * @param {Parser} parser
     * @constructor
     */
    ...
    AstBuilder.prototype.buildStatement = function() {
        ...
        if (this.matches(Token.KEYWORD)) {
            switch (this.value()) {
                ...
                default:
                    throw new Error('Invalid statement, but found "' + this.type() + '" (' + this.value() + ').');
            }
        } else {
    ...
    /**
     * Сборщик выражения с наименьшим приоритетом.
     * @return {AstElement}
     */
    ...
    /**
     * Сборщик арифметического выражения.
     * @return {AstElement}
     */
    ...
    /**
     * Сборщик выражения умножения/деления.
     * @return {AstElement}
     */
